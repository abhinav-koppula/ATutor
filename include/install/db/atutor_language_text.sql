...
INSERT INTO `language_text` VALUES ('en', '_msgs','AT_FEEDBACK_LOGIN_SUCCESS','You have logged in successfully.','2005-02-15 17:07:45','');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','AT_WARNING_CANNOT_REGISTER_LOGGEDIN','You cannot access this link while you are logged in','2013-02-01 13:46:16','');
...
######
## Services Module Language
INSERT INTO `language_text` VALUES ('en', '_module','services','Services',NOW(),'');
INSERT INTO `language_text` VALUES ('en', '_module','services_text','Manage your ATutorSpaces Services',NOW(),'');
INSERT INTO `language_text` VALUES ('en', '_msgs','AT_FEEDBACK_COURSES_REMAINING','There are %s course space(s) remaining.',NOW(),'');
INSERT INTO `language_text` VALUES ('en', '_msgs','AT_FEEDBACK_NOUSER_COURSES_REMAINING','There are %s course space(s) remaining. Ask your ATutorSpaces site administrator to add more courses. ',NOW(),'');
INSERT INTO `language_text` VALUES ('en', '_msgs','AT_FEEDBACK_NOADMIN_COURSES_REMAINING','There are %s course space(s) remaining. Add more courses though the Services tab above.',NOW(),'');

######
## Open Learn module language
INSERT INTO `language_text` VALUES ('en', '_module','ol_search_open_learn','OpenLearn Content',NOW(),'');
INSERT INTO `language_text` VALUES ('en', '_module','update_param','Update Parameters',NOW(),'');
INSERT INTO `language_text` VALUES ('en', '_module','ol_search_open_learn_tool','OpenLearn Content Tool ',NOW(),'');
INSERT INTO `language_text` VALUES ('en', '_module','ol_search_open_learn_text','Search OpenLearn Content',NOW(),'');
...
#adding feedback messages for OL module
...
INSERT INTO `language_text` VALUES ('en', '_msgs','AT_FEEDBACK_EC_PAYMENTS_CONFIG_NEEDED','You will need to configure the Payments module before using it. See the README file link next to the Payments module in the <a href="../mods/_core/modules/index.php">Module Manager</a>. ',NOW(),'');
...
INSERT INTO `language_text` VALUES ('en', '_msgs','AT_FEEDBACK_CREATE_NEW_COURSE','To create a new course, enter the required Title, and modify the optional settings below as needed. You can modify these setting after the course has been created under Manage>Properties. See the Create Course handbook page above for more about creating courses. ',NOW(),'');